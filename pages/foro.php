...
<div class="container-fluid">
    ...
    <div id="navbarSupportedContent" class="collapse navbar-collapse justify-content-start">
        <div class="navbar-nav text-light">
            ...
            <a href="<?=$_SERVER['PHP_SELF']?>" class="nav-item nav-link ">Foro</a>
                    ...
                    <div class="accordion" id="hilos-accordion">
                            ...
                            <div class="card-header">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none w-100 text-start" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#general-hilos" aria-expanded="true"
                                        aria-controls="general-hilos">
                                        <h2>General</h2>
                                    </button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none w-100 text-start" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#experiencias-hilos"
                                        aria-expanded="false" aria-controls="experiencias-hilos">
                                        <h2>Experiencias</h2>
                                    </button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none w-100 text-start" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#analisis-hilos" aria-expanded="false"
                                        aria-controls="analisis-hilos">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none w-100 text-start" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#lanzamientos-hilos"
                                        aria-expanded="false" aria-controls="lanzamientos-hilos">
                                        <h2>Lanzamientos</h2>
                                    </button>
                                </h2>
                            </div>
